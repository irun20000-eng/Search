...
### 2-9. 수학사 도해 — **11장, 전부 눈으로 봤다** (2026-09-08)

노트 88편 중 자체 도해를 가진 것이 **9편(SVG 11장)**. 이 회차에 3장을 새로 그렸고
(`cavalieri-card-stack` · `hyperbola-equal-areas` · `dice-sum-grid`), 기존 8장을 전수로 봤다.
