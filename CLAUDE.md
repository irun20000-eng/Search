...
- **비주얼 톤 = 라이트/웜화이트(#FFF8F0)+Nunito+코랄.** 다크 기본 가정 금지. 큰 시각 변경 전 Figma 시안 확인. 학습카드 임베드는 작게(기본 1장 4분할 요약).
  - **예외 — `math/` 수학사 섹션(2026-08-21 사용자 승인).** 고문서·아카이브 톤: 세리프 본문, 미색 지면(#FAF6EC), 잉크빛 텍스트, 시에나 강조(#9C5A2C), 유형 4색만 절제 사용. **라이트 전용**(다크는 미승인). 사용자가 "기존 Search 톤 유지" 선택지를 보고 이쪽을 고른 의도적 예외이니 되돌리지 말 것. 목업 승인 절차는 그대로 지켰다(`math/_design/mockup-v1.html`).
