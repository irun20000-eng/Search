...
- **1933년 콜모고로프**가 같은 동작을 확률에 한다 — **[[유클리드]]의 기하 서술에 비할 만한 방식**으로 공리에서 확률론을 세웠다[4].
...
1902년 [[앙리 르베그]]가 학위논문 『적분·길이·넓이』에서 적분을 다시 세운다[3]. 리만이 정의역을 쪼갠 자리에서 **르베그는 함숫값을 쪼갠다**[9].
...
- [[미분법 (확장편)]] — 로빈슨의 초실수
- [[앙리 르베그]] — 이 세기의 문을 연 1902년의 사람. 그가 자기가 연 분야에 머물지 않은 이야기
