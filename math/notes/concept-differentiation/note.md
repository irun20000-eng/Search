...
미분이 실제로 무엇을 할 수 있는지 — 최적화, 근사, 미분방정식 — 는 [[미분의 응용]] 쪽에서 다룬다 [14]. 발견 과정의 인물 서사는 [[미적분의 발견]]에, 무한소의 결함과 19세기 엄밀화의 상세는 [[미적분의 엄밀화]]에 있다. 미분을 도구로 쓰는 첫 정리는 [[평균값 정리]]이고, 계산 연습이 가장 잘 되는 대상은 [[다항함수]]다.
...
미분이 실제 문제에서 어떻게 쓰이는지의 사례는 [[미분의 응용]] 쪽이 더 풍부하다 [14].
