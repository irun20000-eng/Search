...
볼차노는 1819년 12월 오스트리아 정부의 압력으로 **정직됐다.** 교수직에서 물러났을 뿐 아니라 **가택연금에 처해졌고, 우편물이 검열됐으며, 출판이 금지됐다**[7]. 1821년부터 1825년까지 교회 재판을 받았고, 자기 견해를 철회하기를 거부해 결국 사임한다[7].
...
유리수만으로는 왜 안 되는지가 한눈에 보인다. $x^2 < 2$ 인 유리수들을 모으면 위로 유계인데, **유리수 안에는 그 상한이 없다.** $\sqrt{2}$ 가 유리수가 아니기 때문이다. 유리수의 수직선에는 **거기에 구멍이 뚫려 있다.**
...
같은 해에 [[미분법 확장편]]이 다루는 사건 — [[카를 바이어슈트라스]]가 **어디서도 미분되지 않는 연속함수**를 내놓은 일 — 도 일어난다. **바닥을 놓는 일과 직관을 무너뜨리는 일이 같은 해에 일어났다.**
...
- **유리수 수직선의 구멍** — $x^2<2$ 인 유리수를 모으면 상한이 없다[4]. "직선에 구멍이 뚫려 있다"는 그림 하나로 완비성이 무엇인지 전달된다.
...
| 1865 | 바이어슈트라스 | 베를린 강의에서 자기 실수 이론을 폈다. 출판하지 않았다[5] |
