...
세계사사건:
  ...
  - 연도: 833
    사건: 알 마문 사망
    수학과의연결: 번역과 연구를 함께 밀어 준 최대 후원자가 사라졌다
  - 연도: 901
    사건: 타비트 이븐 쿠라 사망
...
출처:
  ...
  - 번호: 13
    ...
    유형: 2차
  - 번호: 14
    제목: Wikipedia, Al-Khwarizmi — 『알자브르』가 **813년에서 833년 사이에 편찬**됐고 **선형·이차방정식의 최초의 체계적 해법**을 제시했다는 것, 그 책이 **대략 820년에 쓰였으며 칼리프 마문의 권유로** 집필됐다는 것, 『지즈 알신드힌드』가 역법·천문 계산 37장과 116개 표(사인표 포함)로 이루어졌고 브라마굽타의 표에 크게 기댔다는 것, 『키탑 수라트 알아르드』(833년 완성)가 프톨레마이오스의 좌표를 바탕으로 하되 지중해의 길이와 아시아·아프리카 도시 위치를 개선했다는 것
...
그리고 이 일에는 뜻하지 않은 결과가 따랐다 — **오늘날 남아 있는 그리스 문헌 가운데 일부는 오직 이 번역 산업 덕분에 살아남았다** [10]. 보존은 목적이 아니라 부산물이었다.
...
이 세기를 말할 때 거의 반드시 나오는 이름이 **「지혜의 집」**(Bayt al-Hikma)이다. 국내 사전들은 이를 **830년 칼리프 마문이 그리스어 철학·과학책을 아랍어로 번역할 목적으로 세운 학술원**으로 적는다 [2][3]. 이것은 국내 자료만의 서술이 아니다 — 이 노트가 가장 많이 기대는 해외 자료도 **알 마문이 바그다드에 지혜의 집을 세웠고 그곳이 번역과 연구의 중심이 됐다**고 단정으로 적는다 [9].
...
⚠ **구타스의 설도 정설은 아니다.** 같은 자료가 이어서 적기를, 원형도시 바그다드가 파괴되고 사료가 서로 엇갈리는 탓에 **이 주장 역시 논쟁 중**이며 바그다드에 방대한 도서관이 존재했을 개연성은 높다고 한다 [11].
...
- 그래서 **선형·이차방정식의 최초의 체계적 해법**이 됐다 [14].
...
![폭이 저마다 다른 여섯 구간 위에 칠한 칸과 파선 칸이 겹쳐 있고, 왼쪽 눈금이 오른쪽보다 촘촘하다 — 착상을 보이는 그림이다](../../assets/figures/thabit-unequal-partition.svg)
...
⚠ **제도가 선 것은 8세기 초다** [7]. 이 제도는 통일신라에서 성립해 **고려와 조선으로 이어지므로** [8], 9세기는 그것이 돌아가던 시기에 해당한다.

**그런데 교재 넷은 「중국에서 들어온 산서」 한마디로 묶이지 않는다.** 『철경』과 『구장』은 당나라 산학제도의 교과서인 산경십서에 들어 있지만, **『삼개』와 『육장』의 이름은 중국 문헌에 보이지 않는다** [8]. 일본의 고대 산학제도에 이 둘이 들어 있다는 사실로 미루어 **일찍이 일본에서 활동한 백제계 수학자들이 편찬한 책으로 추정된다** [8].

그래서 두 곳을 「바깥에서 온 책을 제도 안에 앉혔다」로 나란히 놓으면 신라 쪽이 반만 맞는다. 바그다드가 그리스어와 산스크리트를 아랍어로 옮기던 무렵, 신라의 교과에는 **당에서 온 책과 한반도 계통으로 추정되는 책이 섞여 있었다** [8].
...
| 801 | 알 킨디 출생 [1][9] |
| 813~833 | 알 마문 통치. 번역과 연구를 함께 후원 [1][9] |
| 820 | 알 마하니 출생 — 기하 문제를 대수로 옮기는 착상 [9] |
| 820 무렵 | 알콰리즈미 『알자브르』 — 자료에 따라 825, 또는 813~833 사이 [12][14] |
